...
require (
	...
	github.com/ohler55/slip-fhir v0.0.0-00010101000000-000000000000
	github.com/ohler55/slip-ggql v1.3.1
	github.com/ohler55/slip-jet v1.2.0
	github.com/ohler55/slip-message v1.2.0
	github.com/ohler55/slip-mongo v1.3.1
	github.com/ohler55/slip-parquet v1.2.0
